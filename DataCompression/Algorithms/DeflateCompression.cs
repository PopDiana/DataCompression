...
{
    class DeflateCompression : ICompression, IParallelCompression
    {
        private int compressionLevel = 0;
        private FileStream inFileStream;
        private FileStream outFileStream;

        public string CompressedFileExtension => ".def";
        ...
        public int Compress(string inputURL, string outputURL)
        {
            ...
            using (var compressionStream = new DeflateStream(outFileStream, (CompressionLevel) compressionLevel, true))
            {
        ...
        public int Decompress(string inputURL, string outputURL)
        {
            ...
            using (var compressionStream = new DeflateStream(inFileStream, CompressionMode.Decompress))
            {
